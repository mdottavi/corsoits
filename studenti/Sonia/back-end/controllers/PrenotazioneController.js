...
class PrenotazioneController {
    ...
    static async listPrenotazione (req, res) {
        let pagnum = 1;
        if (req.query.pag) {
    ...
    //     try {
    //         let np=await Prenotazione.get(req.params.id_persona);

    //         logger.debug("req.body:", req.body);
    //         if (req.body.post_id) np.setIdPost(req.body.post_id);
    //         if (req.body.pers_id) np.setIdPers(req.body.pers_id);                        
